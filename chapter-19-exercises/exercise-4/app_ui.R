...
# This helps keep thes code organized and easier to debug
...
intro_panel <- tabPanel(
  ...
  p("The below diagram was created by the New York Times to illustrate the increaing level of inequality in the US"),
